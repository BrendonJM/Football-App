...
create table if not exists public.teams (
  ...
  sport_type text not null default 'football' check (sport_type in ('football', 'rugby', 'softball', 'cricket')),
  players_on_field integer not null check (players_on_field between 5 and 15),
